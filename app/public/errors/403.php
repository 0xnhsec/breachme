...
<title>breachme — 403 Forbidden</title>
...
.error-code{font-family:'JetBrains Mono',monospace;font-size:6rem;font-weight:700;line-height:1;background:linear-gradient(135deg,#ff3b3b,#ff6b2b);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;}
.error-icon{font-size:3rem;color:rgba(255,59,59,.3);margin:1rem 0;}
...
<footer class="footer">breachme marketplace &nbsp;·&nbsp; ERROR 403</footer>
</body>
</html>
